              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    ListView.builder(
                      itemCount: vetServices?.vetService?.sessionTypes?.length,
                      shrinkWrap: true,
                      physics: const NeverScrollableScrollPhysics(),
                      itemBuilder: (context, index) {
                        return buildSessionTypeWidget(
                            index, '', vetServices?.vetService?.sessionTypes?[index].name ?? '', context);
                      },
                    ),
                    const SizedBox(
                      height: 20,
                    ...
                    ListView.builder(
                      itemCount: vetServices?.vetService?.contactMediums?.length,
                      shrinkWrap: true,
                      physics: const NeverScrollableScrollPhysics(),
                      itemBuilder: (context, index) {
                        return buildSessionTypeWidget(
                            index, '', vetServices?.vetService?.contactMediums?[index].name ?? '', context);
                      },
                    ),
                    const SizedBox(
                      height: 10,

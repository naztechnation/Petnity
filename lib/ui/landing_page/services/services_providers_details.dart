...
class ServiceProvidersDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<UserCubit>(
      ...
      child:   ServiceProvidersScreen(petProvider: '',),
    );
  }
}

class ServiceProvidersScreen extends StatefulWidget {
  ServiceProvidersScreen({super.key, required this.petProvider});
...
class _ServiceProvidersScreenState extends State<ServiceProvidersScreen> {
  ...
  void initState() {
    ...
    _userCubit.getServiceProviderList(serviceId: '1');
    super.initState();
  }
                ...
                builder: (context, state) {
                  if (state is ServiceProviderListLoading) {
                    ...
                    return EmptyWidget(
                      ...
                      onRefresh: () =>  _userCubit.getServiceProviderList(serviceId: '1'),
                    );
                    ...
                    Modals.showToast(state.userData.status.toString());
                  }

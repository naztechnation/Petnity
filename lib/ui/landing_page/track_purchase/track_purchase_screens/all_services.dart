      ...
      child: SingleChildScrollView(
        child: ListView.builder(
          ...
          children: [
           ...
           if(orderList!.package?.service?.serviceType?.name == 'Vets')...[
               servicesTypes(),
               Container(
            ...
            Container(
              margin: EdgeInsets.symmetric(
                  horizontal: screenSize(context).width * 0.03),
              child: OngoingServiceWidget(allOrders: allOrders[index],),
            ),
           ] ,
             if(orderList!.package?.service?.serviceType?.name == 'Shopping')...[
              OngoingPurchaseWidget()

...
class SessionStatusScreen extends StatelessWidget {
 ...
 SafeArea(child: SizedBox(height: (Platform.isAndroid) ? 44 : 0)),
            ...
            RequestsContent(isChat: false, isRequestAccepted: true, dontShow: true,),
            ...
            Padding(
              ...
              decoration: BoxDecoration(borderRadius: BorderRadius.circular(41),
               ...
               child: Center(
                 child: Text('Accepted', style: TextStyle(color: Colors.green[900],
            ...
            SizedBox(height: 30,),
                ...
                Padding(
                  ...
                  child: CustomText(
                    ...
                    maxLines: 4,
                    text: 'Your dog walking session purchase has been accepted by the service provider, a notification would be sent to you an hour before the  drop off time',

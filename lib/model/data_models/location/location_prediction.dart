...
class LocationPrediction extends Equatable{
  ...
  factory LocationPrediction.fromJson(String str) => LocationPrediction.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory LocationPrediction.fromMap(Map<String, dynamic> json) => LocationPrediction(
  ...
  List<Object?> get props => [description, placeId, reference, structuredFormatting];
}